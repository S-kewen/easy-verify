...
public interface TemplateFeignService {
    ...
    MyResult create(@RequestHeader("Authorization") String authorization, @RequestParam("title") String title, @RequestParam("content") String content, @RequestParam("codeType") int codeType, @RequestParam("codeLen") int codeLen, @RequestParam("remark") String remark);
    ...
    MyResult modify(@RequestHeader("Authorization") String authorization, @RequestParam("id") int id, @RequestParam("title") String title, @RequestParam("content") String content, @RequestParam("codeType") int codeType, @RequestParam("codeLen") int codeLen, @RequestParam("remark") String remark);
